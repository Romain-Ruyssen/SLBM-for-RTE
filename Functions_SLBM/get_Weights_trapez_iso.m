function [Weights,angles] = get_Weights_trapez_iso(Nb_dir,directions)
% Fonction qui sort les poids de la quadrature en utilisant la loi des
% trapèzes pour un scattering isotrope
...
for i_m = 1:Nb_dir
    for i_mp = 1:Nb_dir
        ...
        Weights(i_m,i_mp) = Delta_theta_m1/2 + Delta_theta_p1/2;
    end
end
